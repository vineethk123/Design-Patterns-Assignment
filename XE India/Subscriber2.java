public class Subscriber2 implements Update {
    ...
    public void display() {
        System.out.println("Currency Conversion Rates of INR in USD, GBP and Euro(Subscriber2):");
